...
function exportAll(sheet) {
    ...
    let list = '<link rel="stylesheet" href="https://ssl.gstatic.com/docs/script/css/add-ons1.css">' + '<ol>';
    let row = '';
    let item = '';
...
function exportNotesInRange(sheet,range) {
    ...
    let table = '<link rel="stylesheet" href="https://ssl.gstatic.com/docs/script/css/add-ons1.css">' + '<table style=\'width:100%;border-collapse: collapse\'>';
    let htmlcell = '';
    let superscript = '';
    let key = 0;
    let index = 1;
